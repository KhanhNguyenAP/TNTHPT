...
public class Calculator extends BaseActivity implements Logic.Listener, OnClickListener, OnMenuItemClickListener, CalculatorViewPager.OnPageChangeListener {
    ...
    private CalculatorDisplay mDisplay;//Khai bao bien dai dien class CalculatorDisplay
    private Persist mPersist;//Khai bao bien dai dien class Persist
    private History mHistory;//Khai bao bien dai dien class History
    ...
    public void onCreate(Bundle state) {
        ...
        mLogic.getBaseModule().setOnBaseChangeListener(new BaseModule.OnBaseChangeListener() {
            @Override
    ...
    public void onPause() {
        ...
        mPersist.setMode(mLogic.getBaseModule().getBase());
        mPersist.save();
    }
    ...
    public void onResume() {
        ...
        if(mPersist.getMode() != null) mLogic.getBaseModule().setBase(mPersist.getMode());
    ...
    private void updateDetails() {
        if(mDetails != null && CalculatorSettings.showDetails(getContext())) {
            ...
            if(CalculatorSettings.isPageEnabled(getContext(), NormalPanel.HEX)) {
                switch(mLogic.getBaseModule().getBase()) {
                    case HEXADECIMAL:

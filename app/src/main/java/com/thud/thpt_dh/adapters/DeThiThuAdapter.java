 ...
 */
public class DeThiThuAdapter extends ArrayAdapter<DeThiThu> {
    private Context context;
    private ArrayList<DeThiThu> values;

    public DeThiThuAdapter(Context context, ArrayList<DeThiThu> values) {
    ...
    public View getView(int position, View convertView, ViewGroup parent){
        ...
        text_view_title_monhoc.setText(values.get(position).getTende());
        return rowView;
    }
}

 ...
 */
public class ChuongAdapter extends ArrayAdapter<Chuong> {
    private Context context;
    private ArrayList<Chuong> values;

    public ChuongAdapter(Context context, ArrayList<Chuong> values) {
    ...
    public View getView(int position, View convertView, ViewGroup parent){
        ...
        text_view_title_monhoc.setText(values.get(position).getTenchuong());
        return rowView;
    }
}

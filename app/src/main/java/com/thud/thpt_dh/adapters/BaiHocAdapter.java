...
public class BaiHocAdapter extends ArrayAdapter<BaiHoc> {
    ...
    private ArrayList<BaiHoc> values;

    public BaiHocAdapter(Context context, ArrayList<BaiHoc> values) {
    ...
    public View getView(int position, View convertView, ViewGroup parent){
        ...
        text_view_title_monhoc.setText(values.get(position).getTenbh());
        return rowView;
    }
}
